...
class profile::tomcat (
  ...
  $resource_auth,
  $resource_type,
  $resource_driverClassName,
  $resource_maxTotal,
  $resource_maxIdle,
  $resource_maxWaitMillis,
  ...
  $tomcat_resources_defaults = {
    ...
    auth            => $resource_auth,
    type            => $resource_type,
    driverClassName => $resource_driverClassName,
    maxTotal        => $resource_maxTotal,
    maxIdle         => $resource_maxIdle,
    maxWaitMillis   => $resource_maxWaitMillis,
